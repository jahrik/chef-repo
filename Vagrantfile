...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "wgill-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/orginc"
  #   chef.validation_client_name = "orginc-validator"
  #   chef.validation_key_path = ".chef/orginc-validator.pem"
  # end
end
